...
// make the port number configuable - command line, environment variable, fallback to default
...
app.get('/time',(req, resp, next)=>{
    
    // need to set 2 things when you return a HTTP response
    // status code, content type

    resp.status(200) // set status code
